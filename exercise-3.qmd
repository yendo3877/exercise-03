...
Results: Yes. Species that spend more times moving travel farther overall.
Among 14 families, Hylobatidae and Atilidae have positive correlation.
Variables should be transformed to create well distributed population.
...
Results:
Yes. Species that live in larger groups travel farther overall.
Positive correlation is observed in 7 families. The most significant one belongs to Cercopithecidae.
Variables should be transformed to create well distributed population.
